(function(){
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewrite = function(tokens) {
      this.tokens = tokens;
      this.rewrite_with_extensions(false);
      ...
      this.rewrite_with_extensions(true);
      return this.tokens;
    };
    Rewriter.prototype.rewrite_with_extensions = function(post) {
      var _c, _d, _e, extension;
      _d = Rewriter.extensions;
      for (_c = 0, _e = _d.length; _c < _e; _c++) {
        extension = _d[_c];
        extension.rewrite.apply(this, [extension, post]);
      }
      return true;
    };
