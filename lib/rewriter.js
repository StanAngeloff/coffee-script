(function() {
  ...
  exports.Rewriter = function() {
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        tag = token[0];
        if (tag === 'CLASS' || tag === 'TRAIT' || tag === 'IF' || tag === 'UNLESS') {
          noCall = true;
        }
        ...
        this.detectEnd(i + (callObject ? 2 : 1), function(token, i) {
          ...
          return !token.generated && this.tag(i - 1) !== ',' && __indexOf.call(IMPLICIT_END, tag) >= 0 && (tag !== 'INDENT' || (((_ref = this.tag(i - 2)) !== 'CLASS' && _ref !== 'TRAIT') && (_ref2 = this.tag(i - 1), __indexOf.call(IMPLICIT_BLOCK, _ref2) < 0) && !((post = this.tokens[i + 1]) && post.generated && post[0] === '{')));
        }, action);
        if (prev[0] === '?') {
          prev[0] = 'FUNC_EXIST';
        }
  ...
  IMPLICIT_CALL = ['IDENTIFIER', 'NUMBER', 'STRING', 'JS', 'REGEX', 'NEW', 'PARAM_START', 'CLASS', 'TRAIT', 'IF', 'UNLESS', 'TRY', 'SWITCH', 'THIS', 'BOOL', 'UNARY', '@', '->', '=>', '[', '(', '{', '--', '++'];
