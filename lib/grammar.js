(function(){
  ...
  grammar = {
    ...
    Expression: [o("Value"), o("Call"), o("Curry"), o("Code"), o("Operation"), o("Assign"), o("Using"), o("If"), o("Try"), o("While"), o("For"), o("Switch"), o("Extends"), o("Class"), o("Splat"), o("Existence"), o("Comment"), o("Extension")],
    ...
    Using: [
      o("USING UsingPropertyList OF Expression", function() {
        return new UsingNode($2, $4);
      })
    ],
    ...
    UsingProperty: [
      o("Identifier", function() {
        return new ValueNode($1);
      }), o("UsingProperty PROPERTY_ACCESS Identifier", function() {
        return new ValueNode($1, [new AccessorNode($3)]);
      }), o("UsingProperty INDEX_START Expression INDEX_END", function() {
        return new ValueNode($1, [new IndexNode($3)]);
      })
    ],
    ...
    UsingPropertyList: [
      o("STRING", function() {
        return [new LiteralNode($1)];
      }), o("UsingProperty", function() {
        return [$1];
      }), o("STRING AS Identifier", function() {
        var wrap;
        wrap = new LiteralNode($1);
        wrap.alias = new ValueNode($3);
        return [wrap];
      }), o("UsingProperty AS Identifier", function() {
        $1.alias = new ValueNode($3);
        return [$1];
      }), o("UsingPropertyList , STRING", function() {
        return $1.concat([new LiteralNode($3)]);
      }), o("UsingPropertyList , UsingProperty", function() {
        return $1.concat([$3]);
      }), o("UsingPropertyList , STRING AS Identifier", function() {
        var wrap;
        wrap = new LiteralNode($3);
        wrap.alias = new ValueNode($5);
        return $1.concat([wrap]);
      }), o("UsingPropertyList , UsingProperty AS Identifier", function() {
        $3.alias = new ValueNode($5);
        return $1.concat([$3]);
      })
    ],
  ...
  // And not:
  //     (2 + 3) * 4
  operators = [["left", '?'], ["nonassoc", 'UMINUS', 'UPLUS', '!', '!!', '~', '++', '--'], ["left", '*', '/', '%'], ["left", '+', '-'], ["left", '<<', '>>', '>>>'], ["left", '&', '|', '^'], ["left", '<=', '<', '>', '>='], ["right", 'DELETE', 'INSTANCEOF', 'TYPEOF'], ["left", '==', '!='], ["left", '&&', '||'], ["right", '-=', '+=', '/=', '*=', '%=', '||=', '&&=', '?='], ["left", '.'], ["right", 'INDENT'], ["left", 'OUTDENT'], ["right", 'WHEN', 'LEADING_WHEN', 'IN', 'AS', 'OF', 'BY', 'THROW'], ["right", 'FOR', 'NEW', 'SUPER', 'CLASS'], ["left", 'EXTENDS'], ["right", 'ASSIGN', 'RETURN', 'USING'], ["right", '->', '=>', '<-', 'UNLESS', 'IF', 'ELSE', 'WHILE', 'UNTIL']];
  // Wrapping Up
  // -----------
