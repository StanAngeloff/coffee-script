(function(){
  ...
  grammar = {
    ...
    AssignObj: [
      ...
      }), o("AssignControl Identifier ASSIGN Expression", function() {
        return new AssignNode(new ValueNode($2), $4, 'object', $1);
      }), o("AlphaNumeric ASSIGN Expression", function() {
        return new AssignNode(new ValueNode($1), $3, 'object');
      }), o("AssignControl AlphaNumeric ASSIGN Expression", function() {
        return new AssignNode(new ValueNode($2), $4, 'object', $1);
      }), o("Comment")
    ],
