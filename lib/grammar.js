(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Trait')],
    Block: [
    ...
    Class: [
      o('CLASS', function() {
        ...
        return new Class(null, null, null, $2);
      }), o('CLASS ClassExtends', function() {
        return new Class(null, $2.parent, $2.traits);
      }), o('CLASS ClassExtends Block', function() {
        return new Class(null, $2.parent, $2.traits, $3);
      }), o('CLASS SimpleAssignable', function() {
        return new Class($2);
      }), o('CLASS SimpleAssignable Block', function() {
        return new Class($2, null, null, $3);
      }), o('CLASS SimpleAssignable ClassExtends', function() {
        return new Class($2, $3.parent, $3.traits);
      }), o('CLASS SimpleAssignable ClassExtends Block', function() {
        return new Class($2, $3.parent, $3.traits, $4);
      })
    ],
    ClassExtends: [
      o("EXTENDS Value", function() {
        return new Extends(null, $2);
      }), o("IMPLEMENTS ValueList", function() {
        return new Extends(null, null, $2);
      }), o("EXTENDS Value IMPLEMENTS ValueList", function() {
        return new Extends(null, $2, $4);
      })
    ],
    ValueList: [
      o("Value", function() {
    ...
    Trait: [
      o('TRAIT SimpleAssignable Block', function() {
        return new Trait($2, null, null, $3);
      })
    ],
    Invocation: [
    ...
    Operation: [
      ...
      }), o('SimpleAssignable IMPLEMENTS Expression', function() {
        return new Extends($1, null, [$3]);
      })
    ]
  };
  operators = [['left', '.', '?.', '::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', 'LOGIC'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS', 'IMPLEMENTS'], ['right', 'FORIN', 'FOROF', 'BY', 'WHEN'], ['right', 'IF', 'UNLESS', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'TRAIT'], ['right', 'POST_IF', 'POST_UNLESS']];
  tokens = [];
  for (name in grammar) {
