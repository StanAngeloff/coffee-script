(function(){
  ...
  exports.ClassNode = (function() {
    ...
    ClassNode.prototype.compile_node = function compile_node(o) {
      var _b, _c, _d, _e, access, applied, construct, controls, define, explicit_this, extension, func, prop, props, pvar, returns, val;
      ...
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        ...
        if (pvar && pvar.base.value === 'constructor' && func instanceof CodeNode) {
          ...
          explicit_this = true;
        } else if (pvar && prop.control) {
          define = new ValueNode(literal('this'), [new AccessorNode(literal(this.control[prop.control.value]))]);
  ...
  exports.AssignNode = (function() {
    ...
    AssignNode.prototype.compile_node = function compile_node(o) {
      ...
      if (this.control) {
        return val.replace(/function[^\(]*/, ("" + (this.control.compile(o)) + " " + name)).replace(/^\(+|\)+$/g, '');
      }
