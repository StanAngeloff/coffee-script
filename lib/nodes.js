(function() {
  ...
  exports.Merge = Merge = function() {
    ...
    Merge.prototype.compileNode = function(o) {
      ...
      ref = new Literal(o.scope.freeVariable('ref'));
      node = new For(new Expressions([new Assign(new Value(this.left, [new Index(name)]), ref)]), {
        source: (this.right.isStatement() ? Closure.wrap(this.right) : this.right),
        object: true
      }, name, ref);
      if (o.level > LEVEL_TOP || this.returns) {
        node = new Expressions([node, this.left.makeReturn()]);
      }
      return node.compile(o, LEVEL_TOP);
    };
    return Merge;
  }();
