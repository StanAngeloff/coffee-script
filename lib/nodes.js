(function(){
  ...
  }, __to_array = Array.prototype.slice, __bind = function(func, obj, args) {
    return function() {
  ...
  exports.ValueNode = (function() {
    ...
    ValueNode.prototype.compile_node = function compile_node(o) {
      var _b, _c, _d, _e, _f, baseline, complete, only, op, part, prop, props, replace, soaked, splice, temp, temp_baseline, temp_complete;
      soaked = false;
      ...
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        ...
        if (prop.soak_node) {
          ...
          } else if (prop instanceof IndexNode && prop.is_simple()) {
            _e = [o.scope.free_variable(), o.scope.free_variable()];
            temp_complete = _e[0];
            temp_baseline = _e[1];
            o.array = temp_complete;
            complete = ("(" + temp_complete + " = " + complete + ")" + this.SOAK + "(" + (prop === (_f = props)[-1 + _f.length] ? '' : ("" + temp_baseline + " = ")) + (prop.compile_simple(o)) + ")");
  ...
  exports.IndexNode = (function() {
    ...
    IndexNode.prototype.is_simple = function is_simple() {
      if (this.index instanceof OpNode && this.index.is_unary() && this.index.operator === '-') {
        return true;
      }
    };
    ...
    IndexNode.prototype.compile_simple = function compile_simple(o) {
      ...
      temp = o.scope.free_variable();
      idx = this.index.compile(o);
      return "(" + temp + " = " + array + ")[" + idx + " + " + (temp) + ".length]";
    };
    return IndexNode;
  })();
  //### RangeNode
  ...
  exports.SliceNode = (function() {
    ...
    SliceNode.prototype.compile_utility_call = function compile_utility_call(o, key, args) {
  ...
  exports.SplatNode = (function() {
    ...
    SplatNode.prototype.compile_param = function compile_param(o) {
      ...
      return "" + name + " = " + (utility('to_array')) + ".call(arguments, " + this.index + ", arguments.length - " + (this.trailings.length) + ")";
    };
    ...
    SplatNode.prototype.compile_value = function compile_value(o, name, index, trailings) {
      ...
      return "" + (utility('to_array')) + ".call(" + name + ", " + index + trail + ")";
    };
