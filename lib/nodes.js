(function() {
  var Access, Arr, Assign, Base, Call, Class, Closure, Code, Comment, Existence, Expressions, Extends, For, IDENTIFIER, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, Merge, NEGATE, NO, Obj, Op, Param, Parens, Push, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, TRAILING_WHITESPACE, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref;
  ...
  exports.Base = Base = function() {
    ...
    Base.prototype.eachChild = function(func) {
      var attr, child, _i, _i2, _len, _len2, _ref, _ref2;
      if (!this.children) {
        return this;
      }
      _ref = this.children;
  ...
  exports.Code = Code = function() {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, p, param, ref, scope, sharedScope, splats, v, val, vars, wasEmpty, _i, _i2, _i3, _len, _len2, _len3, _len4, _ref, _ref2, _ref3, _results;
      ...
      _ref3 = this.params;
      for (_i3 = 0, _len3 = _ref3.length; _i3 < _len3; _i3++) {
        param = _ref3[_i3];
        if (param.isComplex()) {
  ...
  exports.Merge = Merge = function() {
    function Merge(left, right, guard) {
      this.left = left;
      this.right = right;
      this.guard = guard;
      this.returns = false;
    }
    __extends(Merge, Base);
    Merge.prototype.children = ['left', 'right'];
    Merge.prototype.isStatement = YES;
    Merge.prototype.makeReturn = function() {
      this.returns = true;
      return this;
    };
    Merge.prototype.compileNode = function(o) {
      var fn, guard, name, nodes, ref;
      ...
      if (this.guard) {
        ...
        nodes.push(new Assign(new Value(new Literal(fn)), this.guard));
        o.sharedScope = o.scope;
        guard = new Call(new Value(new Literal(fn)), function() {
          switch (this.guard.params.length) {
            case 1:
              return [name];
            case 2:
              return [name, ref];
      ...
      nodes.push(new For(new Expressions([new Assign(new Value(this.left, [new Index(name)]), ref)]), {
        source: (this.right.isStatement() ? Closure.wrap(this.right) : this.right),
        object: true,
        guard: guard
      }, name, ref));
      if (o.level > LEVEL_TOP || this.returns) {
        nodes.push(this.left.makeReturn());
      }
      return nodes.compile(o, LEVEL_TOP);
    };
    return Merge;
  }();
  ...
  exports.Switch = Switch = function() {
    ...
    Switch.prototype.compileNode = function(o) {
      var block, body, code, cond, conditions, expr, i, idt1, idt2, _i, _i2, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4, _ref5;
      idt1 = o.indent + TAB;
      ...
      for (i = 0, _len = _ref2.length; i < _len; i++) {
        ...
        for (_i2 = 0, _len3 = _ref5.length; _i2 < _len3; _i2 += -1) {
          expr = _ref5[_i2];
          if (!(expr instanceof Comment)) {
