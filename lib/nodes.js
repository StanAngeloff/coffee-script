(function(){
  ...
  exports.BaseNode = (function() {
    ...
    BaseNode.prototype.compile = function compile(o) {
      ...
      closure = this.is_statement() && !this.is_pure_statement() && !top && !this.options.as_statement && !(this instanceof CommentNode) && !(this instanceof MacroNode) && !this.contains_pure_statement();
      if (closure) {
  ...
  exports.Expressions = (function() {
    ...
    Expressions.prototype.make_return = function make_return() {
      ...
      while (idx && (last instanceof CommentNode || last instanceof MacroNode)) {
    ...
    Expressions.prototype.compile_node = function compile_node(o) {
      ...
      return (function() {
        ...
        for (_c = 0, _i = _d.length; _c < _i; _c++) {
          expression = _d[_c];
          (typeof expression !== "undefined" && expression !== null) ? _b.push(expression) : null;
        }
        return _b;
      }).call(this).join("\n");
    };
  ...
  exports.CallNode = (function() {
    ...
    CallNode.prototype.compile_node = function compile_node(o) {
      var _b, _c, _d, _e, _f, _g, _h, arg, args, call, func, macro_compiled, name;
      _c = this.args;
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        arg = _c[_b];
  ...
  exports.MacroNode = (function() {
    ...
    MacroNode.defined = function defined(name) {
      var _b;
      return (typeof (_b = MacroNode.map[("macro:" + name)]) !== "undefined" && _b !== null);
    };
