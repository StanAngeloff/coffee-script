(function(){
  ...
  exports.AssignNode = (function() {
    ...
    AssignNode.prototype.compile_node = function compile_node(o) {
      ...
      if (MacroNode.defined(val)) {
        MacroNode.map[val].alias((this.macro_alias = name));
        return null;
      }
      if (MacroNode.defined(name)) {
  ...
  exports.MacroNode = (function() {
    ...
    MacroNode.prototype.alias = function alias(name) {
      MacroNode.map[name] = this;
      return MacroNode.map[name];
    };
    MacroNode.defined = function defined(name) {
      var _b;
      return (typeof (_b = MacroNode.map[name]) !== "undefined" && _b !== null);
    };
    MacroNode.unlink = function unlink(name) {
      return delete MacroNode.map[name];
    };
    return MacroNode;
  }).call(this);
  statement(MacroNode);
